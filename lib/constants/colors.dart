...
class AppColors {
  ...
  static const Color primary = Color(0xFFFCFAF7);
  static const Color secondary = Color(0xFFF3EDE5);
  static const Color accent = Color(0xFFE7D7C9);
  static const Color textPrimary = Color(0xFF3C3C3C);
  static const Color textSecondary = Color(0xFF5E564F);
